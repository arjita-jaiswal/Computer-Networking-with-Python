...
//
  ...
  std::map<FlowId, FlowMonitor::FlowStats> stats = monitor->GetFlowStats ();//flow monitor looks like this and keeps track of all nodes
...
//                std::cout<<" seond.delaysum: "<<i->second.delaySum<<"\n";
  ...
  monitor->SerializeToXmlFile("8-1.flowmon", true, true);
